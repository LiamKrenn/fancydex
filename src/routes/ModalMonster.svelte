...
<div class="card m-1 cursor-pointer {((screenSize > 600) ? 'w-96':'w-3/5')}">
	...
	<h1 class="h1 p-2 break-words {((screenSize > 600) ? 'text-5xl mx-2 mb-4':'text-2xl mx-1')} text-center text-surface-800-100-token">
		{name}
	</h1>
	<div class="p-2 break-words {((screenSize > 600) ? 'text-2xl mx-2 mb-4':'mx-1 mb-2')}  text-center text-surface-800-100-token">
		{descr}
	</div>
</div>
